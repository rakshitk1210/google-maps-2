...
const SOURCE_ID = 'carplay-trip-route'
const LAYER_ID = 'carplay-trip-route-line'
...
// teardown — so switching destinations from the itinerary panel re-draws
// smoothly instead of flickering (iteration 13's pattern). If the Directions
// API fails, a straight origin→destination line is drawn; the demo must never
// show a bare map.
