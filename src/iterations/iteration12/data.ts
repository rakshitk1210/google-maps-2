...
// Nav scene: driving west out of Seattle toward Olympic National Park.
export const CARPLAY_CLOCK = '3:36'
export const COMPASS_LABEL = 'W'
...
// Peninsula drive: start on the freeway in Seattle, destination Olympic
// National Park. The directions route runs I-5 → WA-16 → US-101 west, which is
// what the camera animates along.
export const CAR_START: [number, number] = [-122.3255, 47.647]
export const OLYMPIC_NP: [number, number] = [-123.4993, 47.9686]
...
export const GEMINI_PROMPT =
  "Heads up — you're approaching a stretch on US-101 with low network coverage. Want me to download an offline map for the rest of the drive?"
