...
// 12px apart, 16px off the right edge, starting below the banner. Mute is
// live; the rest are decorative for this demo (search is a no-op here — the
// AI road-trip flow lives on the preview screen instead).
