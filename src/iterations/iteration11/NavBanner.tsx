...
import { BANNER_TOWARD, THEN_LABEL } from './roadTripData'
import { MOTION_EMPHASIZED, tokens } from './theme'

interface NavBannerProps {
  /** Road the drive is heading toward — from the current destination. */
  road: string
}
...
// The "Then ↱" chip hangs off the banner's bottom-left corner.
