...
// halo (iteration 7's puck, minus the car morph — iteration 9 swaps to the nav
// chevron instead once driving starts). Per rule 0.10 this is a map element,
// so it carries the pin shadow. Rendered inside a center-anchored
